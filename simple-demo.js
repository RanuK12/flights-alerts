// Demo simple de las alertas mejoradas
...
console.log('- URLs de LEVEL corregidas con parametros especificos');
...
console.log('- Scraping mejorado con multiples selectores');
