// Test simple de las mejoras del bot

console.log('TEST DE MEJORAS DEL FLIGHT PRICE BOT');
console.log('=====================================');
console.log('');

// Funcion para construir URL de LEVEL mejorada
...
console.log('VUELO BARATO ENCONTRADO!');
console.log('');
...
console.log('');
console.log('Importante: Revisa condiciones, equipaje y horarios antes de comprar.');
